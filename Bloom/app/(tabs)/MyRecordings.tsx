...
export default function MyRecordingsScreen() {
  ...
  const renderItem = ({ item }: { item: Recording }) => (
    <View style={styles.itemContainer}>
      ...
      >
        <Feather name="play" size={24} color="#C870FF" />
      </TouchableOpacity>
    </View>
  );
        ...
        ListEmptyComponent={() => (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubText}>
              Go to Mind Unload to save your thoughts.
            </Text>
          </View>
        )}
      />
      <CustomNavBar activeScreen="recordings" />
    </View>
  );
}

const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#120E1A", paddingTop: 80 },
  title: {
    color: "#FFFFFF",
  ...
  itemTextContainer: {},
  itemDay: { color: "#FFFFFF", fontFamily: "Lato-Bold", fontSize: 18 },
  itemDate: {
    color: "#A9A9A9",
  ...
  playButton: {
    padding: 10,
    backgroundColor: "rgba(200, 112, 255, 0.1)",
    borderRadius: 30,
  },
  emptyContainer: {
    flex: 1,
  ...
  emptyText: { color: "#FFFFFF", fontFamily: "Lato-Bold", fontSize: 18 },
  emptySubText: {
    color: "#A9A9A9",
    fontFamily: "Lato-Regular",
    fontSize: 14,
